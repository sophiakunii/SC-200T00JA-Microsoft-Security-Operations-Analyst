...
あなたは Azure Defenderを実装済みの会社で働いているセキュリティオペレーションアナリストです。Azure　Defender　によって生成されたセキュリティ　アラートに応答する必要があります。
...
5. Azure portal の検索バーに「*セキュリティ*」を入力し 「**セキュリティ センター**」 を選択します。
