...
3. データ コネクタ タブで、リストから「**Security Events via Legacy Agent**」 (レガシ エージェントを使用したセキュリティ イベント) コネクタを選択します。
...
4. Azureポータルの検索バーに 「**Sentinel**」と入力し、「**Microsoft Sentinel**」を選択します。

5. Azure Sentinel ワークスペースを選択します。

6. 「**データ コネクタ**」を選択してから、リストから、「**Security Events via Legacy Agent**」 (レガシ エージェントを使用したセキュリティ イベント) コネクタを選択します。
...
6. **notepad sysmon.xml**notepad と入力して、新しいファイルを作成します。「**はい**」を選択して、ファイルの作成を確認します。
...
11. Azure portal の検索バーに、「**Sentinel**」と入力してから、「**Microsoft Sentinel**」を選択し、以前に作成した Azure Sentinel ワークスペースを作成します。
