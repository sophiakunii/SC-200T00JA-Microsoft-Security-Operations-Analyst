...
3. データ コネクタ タブで、リストから「**レガシー エージェントを介したセキュリティ イベント**」コネクタを選択します。
...
6. 「**データ コネクタ**」を選択してから、リストから「**レガシー エージェントを介したセキュリティ イベント**」コネクタを選択します。
...
2. 「**Sysmon のダウンロード**」を選択して、ページからSysmonをダウンロードします。
